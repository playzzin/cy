...
import { faSave, faSearch, faUserTie } from '@fortawesome/free-solid-svg-icons';
...
const PositionAssignment: React.FC = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const initialAssignments = workersData.map(worker => ({
                ...
                currentRole: worker.rank || worker.role || '신규',
                newRole: worker.rank || worker.role || '신규',
        ...
        <div className="h-[calc(100vh-200px)] flex flex-col">
            <div className="flex justify-between items-center mb-4 bg-white p-4 rounded-lg shadow-sm border border-slate-200">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-bold text-slate-800">직책 배정 (드래그 앤 드롭)</h3>
                        <p className="text-xs text-slate-500">오른쪽의 작업자를 왼쪽 직책 박스로 드래그하여 배정 후 저장하세요.</p>
                    </div>
                </div>
                <button
            ...
            >
                <div className="flex-1 grid grid-cols-12 gap-6 min-h-0 overflow-hidden">
                    ...
                    <div className="col-span-5 lg:col-span-4 flex flex-col gap-4 overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div className="col-span-7 lg:col-span-8 bg-white rounded-xl shadow-sm border border-slate-200 flex flex-col overflow-hidden">
