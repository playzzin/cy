...
const env = { ...process.env, NO_UPDATE_NOTIFIER: '1', XDG_CONFIG_HOME: path.resolve('node_modules/.cache/task-notification-emulators') };
...
const firebaseArgs = ['emulators:exec', '--only', 'firestore,auth', '--project', 'demo-cy-tasks', 'node scripts/test-task-notification-rules.mjs'];
