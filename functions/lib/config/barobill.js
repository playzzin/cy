...
const getWsdlUrl = (service = 'tax') => {
    if (exports.BAROBILL_CONFIG.IS_TEST) {
        switch (service) {
            case 'tax': return exports.BAROBILL_CONFIG.TEST_TAX_WSDL_URL;
            case 'kakao': return exports.BAROBILL_CONFIG.TEST_KAKAO_WSDL_URL;
            default: return exports.BAROBILL_CONFIG.TEST_WSDL_URL;
        }
    }
    switch (service) {
        case 'tax': return exports.BAROBILL_CONFIG.PROD_TAX_WSDL_URL;
        case 'kakao': return exports.BAROBILL_CONFIG.PROD_KAKAO_WSDL_URL;
        default: return exports.BAROBILL_CONFIG.PROD_WSDL_URL;
    }
};
