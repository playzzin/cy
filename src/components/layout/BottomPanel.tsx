...
import { faFloppyDisk, faXmark, faUserTag, faCalculator, faNoteSticky, faDatabase, faUserGear } from '@fortawesome/free-solid-svg-icons';
import Calculator from '../tools/Calculator';
import { QuickMemoEditor } from '../tools/QuickMemoEditor';
import { z } from 'zod';
...
const BottomPanel: React.FC<BottomPanelProps> = ({
    ...
    const [activeTab, setActiveTab] = useState<'register' | 'memo' | 'calculator'>('register');
    ...
    return (
        <aside id="bottom-panel" className={`panel ${isOpen ? 'open' : ''}`}>
            <div className="flex flex-col border-b border-white/10">
                ...
                <div className="flex justify-between items-center px-4 py-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-lg tracking-tight">빠른 실행</span>
                    </div>
                ...
                <div className="px-4 pb-3">
                    <div className="flex bg-black/30 rounded-lg p-1 gap-1 w-full sm:w-auto">
                        <button
                            ...
                            className={`flex-1 sm:flex-none justify-center items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'register'
            ...
            <div className="panel-content p-4 overflow-y-auto custom-scrollbar bg-[#1e1e1e]">
                ...
                {activeTab === 'memo' && (
                    <div className="h-full w-full overflow-hidden rounded-lg shadow-xl" style={{ minHeight: '400px' }}>
                        <QuickMemoEditor />
                    </div>
                )}
