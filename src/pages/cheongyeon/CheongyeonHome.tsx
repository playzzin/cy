...
const CheongyeonHome: React.FC = () => {
    ...
    return (
        <div className={`relative min-h-screen ${isDarkMode ? 'bg-slate-900' : 'bg-slate-50'} overflow-x-hidden`}>
            ...
            {/* 1. Recent Daily Report Highlights (Hero Section) */}
            ...
            {/* 2. Innovative System Section (Feature Cards) */}
            <section className={`relative z-10 px-8 py-20 max-w-[1800px] mx-auto transition-all duration-1000 ${isIntro ? 'opacity-0 translate-y-10 pointer-events-none' : 'opacity-100 translate-y-0'}`}>
                <div className="mb-20">
