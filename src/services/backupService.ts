...
const HANDLERS: Record<string, CollectionHandler> = {
    'companies': { dataKey: 'companies', listFn: DC.listAllCompanies, listAllFn: (dcInstance: any, vars: any) => DC.listAllCompanies(dcInstance, vars), createFn: DC.createCompany, updateFn: DC.updateCompany, deleteFn: DC.deleteCompany, useFirestoreFallback: false },
    'teams': { dataKey: 'teams', listFn: DC.listAllTeams, listAllFn: (dcInstance: any, vars: any) => DC.listAllTeams(dcInstance, vars), createFn: DC.createTeam, updateFn: DC.updateTeam, deleteFn: DC.deleteTeam, useFirestoreFallback: false },
    'workers': { dataKey: 'workers', listFn: DC.listAllWorkers, listAllFn: (dcInstance: any, vars: any) => DC.listAllWorkers(dcInstance, vars), createFn: DC.createWorker, updateFn: DC.updateWorker, deleteFn: DC.deleteWorker, useFirestoreFallback: false },
    'sites': { dataKey: 'sites', listFn: DC.listAllSites, listAllFn: (dcInstance: any, vars: any) => DC.listAllSites(dcInstance, vars), createFn: DC.createSite, updateFn: DC.updateSite, deleteFn: DC.deleteSite, useFirestoreFallback: false },
    'positions': { dataKey: 'positions', listFn: DC.listAllPositions, listAllFn: (dcInstance: any, vars: any) => DC.listAllPositions(dcInstance, vars), createFn: DC.createPosition, updateFn: undefined, deleteFn: DC.deletePosition, useFirestoreFallback: false },
    'daily_reports': { dataKey: 'dailyReports', listFn: DC.listAllDailyReports, listAllFn: (dcInstance: any, vars: any) => DC.listAllDailyReports(dcInstance, vars), createFn: DC.createDailyReport, deleteFn: DC.deleteDailyReport, useFirestoreFallback: false },
    'daily_report_workers': { dataKey: 'dailyReportWorkers', listFn: undefined, listAllFn: undefined, createFn: DC.createDailyReportWorker, updateFn: DC.updateDailyReportWorker, deleteFn: DC.deleteDailyReportWorker, useFirestoreFallback: true },
    'app_users': { dataKey: 'appUsers', listFn: DC.listAllAppUsers, listAllFn: (dcInstance: any, vars: any) => DC.listAllAppUsers(dcInstance, vars), useFirestoreFallback: true },
    'menu_configs': { dataKey: 'menuConfigs', listFn: undefined, listAllFn: undefined, useFirestoreFallback: true },
    'system_logs': { dataKey: 'systemLogs', listFn: undefined, listAllFn: undefined, createFn: DC.createSystemLog, useFirestoreFallback: true },
    'vehicles': {
        dataKey: 'vehicles',
    ...
    'settings': { dataKey: 'settings', listFn: undefined, listAllFn: undefined, useFirestoreFallback: true },
    'system_configs': { dataKey: 'systemConfigs', listFn: undefined, listAllFn: undefined, useFirestoreFallback: true },
    ...
    'accommodation_billing_documents': { dataKey: 'accommodationBillingDocuments', listFn: DC.listAllAccommodationBillingDocuments, listAllFn: (dcInstance: any, vars: any) => DC.listAllAccommodationBillingDocuments(dcInstance, vars), createFn: DC.createAccommodationBillingDocument, deleteFn: undefined, useFirestoreFallback: true },
    'accommodation_billing_line_items': { dataKey: 'accommodationBillingLineItems', listFn: undefined, listAllFn: undefined, createFn: DC.createAccommodationBillingLineItem, deleteFn: DC.deleteAccommodationBillingLineItem, useFirestoreFallback: true },
    ...
    'agents': { dataKey: 'agents', listFn: DC.listAllAgents, listAllFn: (dcInstance: any, vars: any) => DC.listAllAgents(dcInstance, vars), createFn: DC.createAgent, updateFn: DC.updateAgent, useFirestoreFallback: true },
    'agent_conversations': { dataKey: 'agentConversations', listFn: DC.listAllAgentConversations, listAllFn: (dcInstance: any, vars: any) => DC.listAllAgentConversations(dcInstance, vars), createFn: DC.createAgentConversation, updateFn: DC.updateAgentConversation, useFirestoreFallback: true },
    'audit_logs': { dataKey: 'auditLogs', listFn: undefined, listAllFn: undefined, useFirestoreFallback: true },
};
