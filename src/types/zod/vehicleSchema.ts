...
export const vehicleExpenseSchema = z.object({
    ...
    importSource: z.enum(['GEMINI_FINE_NOTICE', 'GEMINI_TOLL_USAGE']).optional(),
    fineNotice: z.object({
    ...
    tollUsage: z.object({
        sourceFileName: z.string(),
        sourceSha256: z.string().regex(/^[a-f0-9]{64}$/).optional(),
        fileNameVehicleSuffix: z.string().default(''),
        provider: z.string(),
        extractedLicensePlate: z.string(),
        licensePlateCandidates: z.array(z.string()),
        transactionDate: z.string(),
        transactionTime: z.string(),
        transactionDateTime: z.string(),
        entryTollgate: z.string(),
        exitTollgate: z.string(),
        routeName: z.string(),
        transactionNumber: z.string(),
        approvalNumber: z.string(),
        statementPeriod: z.string().default(''),
