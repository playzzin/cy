...
const OrganizationChartPage: React.FC = () => {
    const [viewMode, setViewMode] = useState<'company' | 'site' | 'team' | 'logic' | 'ai' | 'd3tree' | 'premium' | 'radial' | 'interactive'>('interactive');
            ...
            <div className="bg-white border-b border-slate-200 p-4 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 bg-slate-100 p-1 rounded-lg">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-md text-sm font-bold transition-all ${viewMode === 'interactive' ? 'bg-gradient-to-r from-indigo-500 to-blue-500 text-white shadow-md' : 'text-slate-500 hover:text-slate-700'}`}
                    >
