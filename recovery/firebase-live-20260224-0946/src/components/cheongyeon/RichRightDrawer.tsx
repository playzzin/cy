...
const RichRightDrawer: React.FC<RichRightDrawerProps> = ({ isOpen, onClose, currentSiteData, menuPaths, changeSite, scrolled }) => {
    const navigate = useNavigate();
    const [activeSubMenu, setActiveSubMenu] = useState<string | null>(null);

    // Header dimensions based on scroll state
    const headerHeight = scrolled ? 70 : 90;
    ...
    return (
        <div
            className="fixed right-0 z-[2000] pointer-events-none transition-all duration-300"
            style={{
                top: `${headerHeight}px`,
