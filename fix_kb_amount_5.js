...
const regex = /value=\{kbMemoSuffix\}\s*onChange=\{\(e\) => setKbMemoSuffix\(e\.target\.value\)\}\s*className="border border-slate-300 rounded px-2 py-1 text-sm w-32 focus:ring-amber-500 focus:border-amber-500"\s*\/>\s*<\/div>/;

const replacement = `value={kbMemoSuffix}
